...
const EventCard: React.FC<EventCardProps> = ({ event, onCancel, onOpen }) => {
  ...
  return (
    <div
      ...
      className="bg-[#1D1C2C] hover:bg-[#21202e] hover:border-[#4844A2] rounded-2xl p-3 flex justify-between items-start text-white border-2 max-w-full border-[#312E72] cursor-pointer"
    >
      ...
      >
        <button 
          ...
          className="text-center justify-start text-[#C3BFFF] text-base font-semibold border-2 border-[#5D59AD] rounded-md px-4 py-3 hover:text-white hover:border-white"
        >
          Remove
        </button>
      </div>
